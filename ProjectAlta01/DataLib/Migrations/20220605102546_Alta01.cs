...
{
    public partial class Alta01 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    gender = table.Column<bool>(type: "bit", nullable: true),
                    birthDay = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Class = table.Column<string>(type: "varchar(5)", unicode: false, maxLength: 5, nullable: true),
                    Status = table.Column<bool>(type: "bit", nullable: true, defaultValue: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Admin = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: true, defaultValue: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    classCourseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    lession = table.Column<DateTime>(type: "date", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Class_Course", x => x.classCourseId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    classTestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    isComplete = table.Column<int>(type: "int", nullable: true, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearnintOutcome", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LearnintOutcome_Student_Student",
                        column: x => x.Student,
                        principalTable: "Student",
                        principalColumn: "studentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LearnintOutcome_Student_Test_Student_Test",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LearnintOutcome_Student",
                table: "LearnintOutcome",
                column: "Student");

            migrationBuilder.CreateIndex(
                name: "IX_LearnintOutcome_Student_Test",
                table: "LearnintOutcome",
                column: "Student_Test");
